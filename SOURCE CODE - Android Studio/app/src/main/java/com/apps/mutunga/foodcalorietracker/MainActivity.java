...
import com.apps.mutunga.foodcalorietracker.database.DBHelper;
import com.apps.mutunga.foodcalorietracker.fragments.ChartFragment;
import com.apps.mutunga.foodcalorietracker.fragments.ProfileFragment;
import com.apps.mutunga.foodcalorietracker.model.InfoModel;
...
//                linearLayout.setVisibility(View.VISIBLE);
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbHelper.addDetails(f_name, f_date, f_time, Float.parseFloat(f_fat), Float.parseFloat(f_proteins), Float.parseFloat(f_cal), Float.parseFloat(f_carbs));
                        dialog.dismiss();
